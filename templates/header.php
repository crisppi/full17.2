          ...
          <ul class="nav-tabs navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                ...
                <li>
                <li><a class="dropdown-item" href="<?php $BASE_URL ?>cad_internacao_niveis.php">Níveis</a></li>
                <li>
                  <hr class="dropdown-divider">
                </li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                <li><a class="dropdown-item" href="<?php $BASE_URL ?>list_internacao_cap.php">Lançar Contas</a></li>
                <li>
