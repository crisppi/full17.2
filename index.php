...
<div class="container-fluid">
    <div class="row full-height" style="background-color:#e9e9e9">
            ...
            <div class="row full-height justify-content-center">
                <div class="col-8 col-xxl-5 align-self-center">
                    ...
                    <form method="post">
                        ...
                        <br />
                        <input class="input border-0 border-bottom p-2" style="border-radius:10px" placeholder="Senha" type="password" />
                        <br />
        ...
        <div class="col-md-6 col-12 full-height d-none d-md-block">
            <img src="img/black.jpg" style="width:100%; height:100%; opacity:0,5; border-radius:20px" alt="Full">
        </div>
    </div>
</div>
