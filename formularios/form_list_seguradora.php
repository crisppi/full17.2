<body>
    ...
    <div class="container py-2">
        <div class="row">
            <h2 class="page-title">Seguradora</h2>
            ...
            <form class="formulario" id="form_pesquisa" method="GET">
                <div class="form-group row">
                    ...
                    <div class="form-group col-sm-2 ">
                        ...
                        <input type="text" name="pesquisa_nome" style=" border:0rem" id="pesquisa_nome" value="<?= $busca ?>" autofocus placeholder="Pesquisa por seguradora">
                    </div>
        ...
        <div class="container">
            ...
            <div>
                <hr>
                <a class="btn btn-success styled" style="margin-left:10px" href="cad_seguradora.php">Nova seguradora</a>
            </div>
        </div>
</body>
