<div id="container-uti" class="container" style="display:none">
    ...
    <form class="formulario" action="<?= $BASE_URL ?>process_uti.php" id="add-acomodacao-form" method="POST" enctype="multipart/form-data">
        ...
        <div class=" form-group row">
            ...
            <div>
                <input type="   " class="form-control" id="internacao_uti_int" name="internacao_uti_int" value="s">
            </div>
            <div>
                <input type="   " class="form-control" id="internado_uti_int" name="internado_uti_int" value="s">
            </div>
