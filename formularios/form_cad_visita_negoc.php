<div id="container-negoc" class="formulario" style="display:none">
    ...
    <form class="formulario" action="<?= $BASE_URL ?>process_negociacao.php" id="add-negociacao-form" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group col-sm-1">
            ...
            ?>
            <div>
                <input type="hidden" class="form-control" id="fk_id_int" value="<?= $id_internacao ?>" name="fk_id_int" placeholder="<?= $id_internacao ?>">
            </div>
            <div>
                <input type="hidden" class="form-control" id="fk_id_int" value="<?= $ultimoReg ?>" name="fk_id_int" placeholder="<?= $ultimoReg ?>">
            </div>
